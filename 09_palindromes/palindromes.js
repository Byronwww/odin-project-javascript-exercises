const palindromes = function(potentialPalindrome) {
  const potentialPalindromeLength = potentialPalindrome.length;
  ...
  // This loop reverses the cleanedString and
  // checks if it still matches once reversed
  ...
  const cleanStringLowerCase = cleanString.toLowerCase();
  const reversedStringLowerCase = reversedString.toLowerCase();
