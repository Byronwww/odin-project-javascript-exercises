...
* comparing it against each value in the itemsToRemove rest parameter
* (which is essentially an array)
* @param {array} item - the array to be filtered
* @return {boolean}
*/
  ...
  // This returns the filtered array by first calling a function called
  // filterItems
  ...
  // But, if your function returns false, it will remove the item from  array.
